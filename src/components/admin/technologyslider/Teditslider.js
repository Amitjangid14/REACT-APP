        ...
        axios
            ...
            .then(response => {
                this.setState({
                    ...
                    file: Url.baseUrl + '/public/uploads/technology/' + response.data.data.image,
        ...
        axios
            ...
            .then(res => {
                if (res.data.status === 200) {
                    ...
                    setTimeout(() => {
                        window.location = "/admin/tsliderlist";
                    }, 3000);
                }
                if (
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    ...
                                    <li className="breadcrumb-item active">Edit Technology Slider</li>
                                </ol>
                            </div>
                        </div>
                    </div>
