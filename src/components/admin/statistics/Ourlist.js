                    ...
                    <table id="example" className="table align-items-center justify-content-center mb-0">
                        ...
                        <tbody>
                            {this.state.list.map((pslider,i) => (<tr key={(pslider.id)}>
                                <td>{i+1}</td>
                                <td><img src={Url.baseUrl + '/public/uploads/statistics/' + pslider.image} style={{ width: '50px', height: '50px' }} /></td>
                                <td>{pslider.title}</td>
                                <td>{pslider.subtitle}</td>
                                <td>
                                    <Link to={`/admin/ouredit/${pslider.id}`} className='btn btn-primary btn-sm me-2'>
                                        Edit
                                    </Link>
                                </td>
                            </tr>))}
