...
class Peditslider extends Component {
    ...
    fetchData = () => {
        axios
            .post(Url.baseUrl + `api/getpslideredit/${this.props.params.id}`)
            .then(response => {
                this.setState({
                    title: response.data.data.title,
                    subtitle: response.data.data.subtitle,
                    file: Url.baseUrl + '/public/uploads/portfolioslider/' + response.data.data.image,
    ...
    handleSubmit(e) {
        ...
        axios
            .post(Url.baseUrl + 'api/updatepslider', firstFormData)
            .then(res => {
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                <h2 className="m-0">Edit Portfolio Slider</h2>
                            </div>
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    <li className="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
                                    <li className="breadcrumb-item active">Edit Portfolio Slider</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <form id="quickForm" onSubmit={this.handleSubmit.bind(this)}>
                                    <div className="card-body">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <select name="category" className="form-control" id="category" value={this.state.category} onChange={this.selectCategory}>
                                                {catList}
                                            </select>
                                        </div>
                                        <div className="form-group">
