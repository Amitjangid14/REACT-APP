...
export default class Addslider extends Component {
    ...
    handleSubmit(e) {
        ...
        axios
            .post(Url.baseUrl+'api/abouttab-add', firstFormData, {})
            .then(res => {
                if (res.data.status === 200) {
                    console.log(res.data.status);
                    toast.success('successfull') 
                    setTimeout(() => {
                        window.location="/admin/abouttab-list"; 
                    }, 3000);
                }
                if (
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                <h2 className="m-0">Add About Tab</h2>
                            </div>
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    <li className="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
                                    <li className="breadcrumb-item active">Add About Tab</li>
                                </ol>
                            </div>
                        </div>
                    </div>
